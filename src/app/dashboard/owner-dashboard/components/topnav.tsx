...
const pageTitles: Record<string, string> = {
  "/dashboard/owner-dashboard": "Dashboard - Home",
  "/dashboard/owner-dashboard/overview": "Dashboard - Overview",
  "/dashboard/owner-dashboard/campaigns": "Dashboard - Campaigns",
  "/dashboard/owner-dashboard/loyalty": "Dashboard - Loyalty",
  "/dashboard/owner-dashboard/feedback": "Dashboard - Feedback",
  "/dashboard/owner-dashboard/customers": "Dashboard - Customers",
  "/dashboard/owner-dashboard/tables": "Dashboard - Tables"
};

const searchPlaceholders: Record<string, string> = {
  "/dashboard/owner-dashboard": "Search...",
  "/dashboard/owner-dashboard/overview": "Search analytics...",
  "/dashboard/owner-dashboard/campaigns": "Search campaigns...",
  "/dashboard/owner-dashboard/loyalty": "Search loyalty...",
  "/dashboard/owner-dashboard/feedback": "Search feedback...",
  "/dashboard/owner-dashboard/tables": "Search tables..."
};
