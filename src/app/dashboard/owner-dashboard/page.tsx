        ...
        <header className="sticky top-0 z-30 hidden border-b border-[#E5E5E5] bg-white/80 px-8 py-5 backdrop-blur-md lg:block">
          <div className="flex items-center justify-between gap-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="ml-2 transition-colors [&_button]:rounded-full [&_button]:bg-black [&_button]:px-5 [&_button]:py-2 [&_button]:text-sm [&_button]:font-medium [&_button]:text-white hover:[&_button]:bg-[#333333]">
                <LogoutButton />
              </div>
            </div>
          </div>
